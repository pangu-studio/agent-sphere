#!/bin/bash
# Build a Debian x86_64 rootfs with Hermes Agent as qcow2 for AgentSphere.
#
...
WORK_ROOT="${AGENTSPHERE_WORK_DIR:-/tmp/tenbox-rootfs-hermes-x86_64}"
...
Build a Debian x86_64 rootfs image with Hermes Agent for AgentSphere macOS.
